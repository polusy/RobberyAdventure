...
public class RescueProgressGUI extends javax.swing.JDialog {
    ...
    public void initProperties(){
        ...
        jList1.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting())
                rescuedGameName = jList1.getSelectedValue();
        });
   }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Carica salvataggio");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            robberyAdventure = clientManager.getGameSavingRequest(rescuedGameName);
            dispose();
        }
        else
            JOptionPane.showMessageDialog(rootPane, "Nessun salvataggio selezionato!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RescueProgressGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RescueProgressGUI dialog = new RescueProgressGUI();
